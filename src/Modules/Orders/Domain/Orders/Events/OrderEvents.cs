...
public sealed record OrderConfirmed(OrderId OrderId, Guid TenantId, Guid BuyerId) : IDomainEvent;
...
public sealed record OrderFailed(OrderId OrderId, Guid TenantId, string Reason) : IDomainEvent;
