...
public class ProductTests
{
    ...
    {
        var r = Product.Create("Widget", Money.Usd(10m), 50, Seller, Now);
    ...
    {
        Product.Create(name, Money.Usd(10m), 50, Seller, Now)
    ...
    {
        Product.Create(new string('x', 201), Money.Usd(10m), 50, Seller, Now)
            .Error.Should().Be(ProductErrors.InvalidName);
    }
    ...
    {
        Product.Create("Widget", Money.Usd(price), 50, Seller, Now)
    ...
    {
        Product.Create("Widget", Money.Usd(10m), -1, Seller, Now)
    ...
    {
        var p = Product.Create("Widget", Money.Usd(10m), 10, Seller, Now).Value;
        p.ClearDomainEvents();
    ...
    {
        var p = Product.Create("Widget", Money.Usd(10m), 5, Seller, Now).Value;
        p.ClearDomainEvents();
